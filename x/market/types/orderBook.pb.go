...
func (*OrderBook) Descriptor() ([]byte, []int) {
	return fileDescriptor_7c587caa09e5c2c4, []int{0}
}
...
func (m *OrderBook) GetOrderIDTrack() int32 {
	if m != nil {
...
func (m *OrderBook) GetAmountDenom() string {
	if m != nil {
...
func (m *OrderBook) GetExchRateDenom() string {
	if m != nil {
...
func init() {
	proto.RegisterType((*OrderBook)(nil), "onomyprotocol.onomy.market.OrderBook")
}

func init() { proto.RegisterFile("market/orderBook.proto", fileDescriptor_7c587caa09e5c2c4) }

var fileDescriptor_7c587caa09e5c2c4 = []byte{
	// 244 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *OrderBook) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ExchRateDenom) > 0 {
		...
		i = encodeVarintOrderBook(dAtA, i, uint64(len(m.ExchRateDenom)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.AmountDenom) > 0 {
		...
		i = encodeVarintOrderBook(dAtA, i, uint64(len(m.AmountDenom)))
		i--
		dAtA[i] = 0x22
	}
	if m.OrderIDTrack != 0 {
		i = encodeVarintOrderBook(dAtA, i, uint64(m.OrderIDTrack))
		i--
		dAtA[i] = 0x18
	}
	if len(m.Index) > 0 {
...
func (m *OrderBook) Size() (n int) {
	...
	if m.OrderIDTrack != 0 {
		n += 1 + sovOrderBook(uint64(m.OrderIDTrack))
	}
	l = len(m.AmountDenom)
	if l > 0 {
		n += 1 + l + sovOrderBook(uint64(l))
