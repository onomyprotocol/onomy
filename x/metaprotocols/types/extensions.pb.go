...
// source: onomy/metaprotocols/extensions.proto
...
func init() {
	proto.RegisterType((*ExtensionData)(nil), "onomy.metaprotocols.ExtensionData")
}

func init() {
	proto.RegisterFile("onomy/metaprotocols/extensions.proto", fileDescriptor_2f741ff82d908382)
}
