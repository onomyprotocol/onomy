// Package dao contains dao module implementation.
package dao
...
// DefaultGenesis returns the dao module's default genesis state.
...
// RegisterRESTRoutes registers the dao module's REST service handlers.
...
// GetTxCmd returns the dao module's root tx command.
func (a AppModuleBasic) GetTxCmd() *cobra.Command {
	return cli.GetTxCmd()
}

// GetQueryCmd returns the dao module's root query command.
...
// Route returns the dao module's message routing key.
func (am AppModule) Route() sdk.Route {
	return sdk.NewRoute(types.RouterKey, NewHandler())
}

// QuerierRoute returns the dao module's query routing key.
func (AppModule) QuerierRoute() string { return types.QuerierRoute }

// LegacyQuerierHandler returns the dao module's Querier.
...
// InitGenesis performs the dao module's genesis initialization It returns
...
// ExportGenesis returns the dao module's exported genesis state as raw JSON bytes.
