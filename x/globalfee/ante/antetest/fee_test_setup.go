...
import (
	...
	onomyparams "github.com/onomyprotocol/onomy-rebuild/app/params"
	"github.com/onomyprotocol/onomy-rebuild/x/globalfee"
	onomyfeeante "github.com/onomyprotocol/onomy-rebuild/x/globalfee/ante"
	globfeetypes "github.com/onomyprotocol/onomy-rebuild/x/globalfee/types"
)

type IntegrationTestSuite struct {
	suite.Suite

	app       *onomyapp.OnomyApp
	ctx       sdk.Context
...
func (s *IntegrationTestSuite) SetupTest() {
	app := onomyhelpers.Setup(s.T())
	ctx := app.BaseApp.NewContext(false, tmproto.Header{
		ChainID: fmt.Sprintf("test-chain-%s", tmrand.Str(4)),
		Height:  1,
	})

	encodingConfig := onomyparams.MakeEncodingConfig()
...
func (s *IntegrationTestSuite) SetupTestGlobalFeeStoreAndMinGasPrice(minGasPrice []sdk.DecCoin, globalFeeParams *globfeetypes.Params) (onomyfeeante.FeeDecorator, sdk.AnteHandler) {
	...
	// build fee decorator
	feeDecorator := onomyfeeante.NewFeeDecorator(subspace, s.app.StakingKeeper)
