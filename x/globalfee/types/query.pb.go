...
// source: onomy/globalfee/v1beta1/query.proto
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "onomy.globalfee.v1beta1.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "onomy.globalfee.v1beta1.QueryParamsResponse")
}

func init() {
	proto.RegisterFile("onomy/globalfee/v1beta1/query.proto", fileDescriptor_12a736cede25d10a)
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/onomy.globalfee.v1beta1.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/onomy.globalfee.v1beta1.Query/Params",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "onomy.globalfee.v1beta1.Query",
	...
	Metadata: "onomy/globalfee/v1beta1/query.proto",
}
