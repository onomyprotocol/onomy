...
docker run --name onomy_all_up_test_instance --cap-add=NET_ADMIN -t gravity-base /bin/bash /onomy/tests/gravity/container-scripts/all-up-test-internal.sh $NODES $TEST_TYPE
