...
docker run --name onomy_gravity_all_up_test_instance $PLATFORM_CMD --cap-add=NET_ADMIN -t onomy-arc-base /bin/bash /onomy/tests/gravity/container-scripts/all-up-test-internal.sh $NODES $TEST_TYPE $ALCHEMY_ID
