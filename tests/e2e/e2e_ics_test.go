...
/*
AddRemoveConsumerChain tests adding and subsequently removing a new consumer chain to Onomy.
Test Benchmarks:
...
func (s *IntegrationTestSuite) AddRemoveConsumerChain() {
	...
	s.execQueryConsumerChains(s.chainA, 0, onomyHomePath, validateConsumerAddition, consumerChainID)
	...
	s.execQueryConsumerChains(s.chainA, 0, onomyHomePath, validateConsumerRemoval, consumerChainID)
}
