...
func (s *IntegrationTestSuite) testDistribution() {
	...
	s.execSetWithdrawAddress(s.chainA, 0, fees.String(), delegatorAddress.String(), newWithdrawalAddress.String(), onomyHomePath)
	...
	s.execWithdrawReward(s.chainA, 0, delegatorAddress.String(), valOperAddressA, onomyHomePath)
	s.Require().Eventually(
		func() bool {
