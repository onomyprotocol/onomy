...
func (s *IntegrationTestSuite) testLSM() {
	...
	// Validator bond
	s.executeValidatorBond(s.chainA, 0, validatorAddressA, validatorAAddr.String(), onomyHomePath, fees.String())
	...
	s.execDelegate(s.chainA, 0, delegation.String(), validatorAddressA, delegatorAddress.String(), onomyHomePath, fees.String())
	...
	s.executeTokenizeShares(s.chainA, 0, tokenize.String(), validatorAddressA, delegatorAddress.String(), onomyHomePath, fees.String())
	...
	s.executeTransferTokenizeShareRecord(s.chainA, 0, strconv.Itoa(recordID), delegatorAddress.String(), validatorAAddr.String(), onomyHomePath, standardFees.String())
	...
	s.executeRedeemShares(s.chainA, 0, redeemAmount.String(), validatorAAddr.String(), onomyHomePath, fees.String())
