...
func (s *IntegrationTestSuite) testStaking() {
	...
	s.execRedelegate(s.chainA, 0, redelegation.String(), validatorAddressA, validatorAddressB, delegatorAddress.String(), onomyHomePath, fees.String())
	...
	s.execUnbondDelegation(s.chainA, 0, currDelegation.String(), validatorAddressA, delegatorAddress.String(), onomyHomePath, fees.String())
