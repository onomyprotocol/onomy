...
require (
	...
	github.com/onomyprotocol/arc/module/bnb v0.0.0-00010101000000-000000000000
...
replace (
	...
	github.com/onomyprotocol/arc/module/bnb => github.com/onomyprotocol/arc/module v0.0.0-20230202190859-8e0556466b4b
