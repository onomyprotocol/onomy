...
## Cosmos Hub Upgrade to Onomy <Version>

<!-- TODO: Replace <Version> by the actual Onomy version -->
...
- [ ] Prep Onomy docs: `docs/getting-started/quickstart.md`, `docs/hub-tutorials/join-mainnet.md`, `docs/migration/` (open PR)
...
- [ ] Reach out to main dependency teams -- Comet, IBC, SDK -- for assistance during the upgrade (#onomy-release-warroom on Slack)
```
...
```[tasklist]
## Post Upgrade 
- [ ] Merge PRs for Onomy docs & chain-registry update
