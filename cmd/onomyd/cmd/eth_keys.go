...
// EthereumKeyOutput is ethereum key output.
...
func runAddCmd(cmd *cobra.Command, args []string) error {
	...
	if dryRun, _ := cmd.Flags().GetBool(flags.FlagDryRun); !dryRun { // nolint: errcheck,nestif
...
func printCreate(cmd *cobra.Command, keyOutput EthereumKeyOutput) error {
	output, _ := cmd.Flags().GetString(cli.OutputFlag) // nolint: errcheck
