...
$ONOMY gentx --ip $ONOMY_HOST $ONOMY_VALIDATOR_NAME "$(jq -r .address $ONOMY_HOME/eth_key.json)" "$(jq -r .address $ONOMY_HOME/orchestrator_key.json)" $ONOMY_KEYRING_FLAG $ONOMY_CHAINID_FLAG
