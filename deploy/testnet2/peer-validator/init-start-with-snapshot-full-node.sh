...
read -r -p "Enter Hostname/IP Address of the same node to fetch genesis file [testnet1.onomy.io]:" ONOMY_SEED_IP
ONOMY_SEED_IP=${ONOMY_SEED_IP:-"testnet1.onomy.io"}

read -r -p "Enter seeds of node which have enabled snapshot [node_Id1@IP_node_Id1:26656,node_Id2@IP_node_Id2:26656]:" ONOMY_SEED
