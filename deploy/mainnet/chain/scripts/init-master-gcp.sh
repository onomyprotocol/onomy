...
# Getting mnemonic for the validator
ONOMY_VALIDATOR_MNEMONIC=$(gcloud secrets versions access 1 --secret=$GCP_VALIDATOR_MNEMONIC)
# The name of the onomy validator
ONOMY_VALIDATOR_NAME="validator"
# Getting mnemonic for the eth-orchestrator
ONOMY_ETH_ORCHESTRATOR_MNEMONIC=$(gcloud secrets versions access 1 --secret=$GCP_ETH_ORCH_MNEMONIC)
...
echo $ONOMY_VALIDATOR_MNEMONIC | onomyd keys add --recover $ONOMY_VALIDATOR_NAME $ONOMY_KEYRING_FLAG
echo "Adding orchestrator keys"
echo $ONOMY_ETH_ORCHESTRATOR_MNEMONIC | onomyd keys add --recover $ONOMY_ETH_ORCHESTRATOR_NAME $ONOMY_KEYRING_FLAG
