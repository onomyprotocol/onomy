...
echo "---------------installing eth bridge solidity-------------------"
curl -LO https://github.com/onomyprotocol/arc/releases/download/$ETH_BRIDGE_VERSION/contract-deployer
mv contract-deployer $ONOMY_HOME/bin/contract-deployer

mkdir -p $ONOMY_HOME/contracts/eth-bridge
curl -LO https://github.com/onomyprotocol/arc/releases/download/$ETH_BRIDGE_VERSION/Gravity.json
mv Gravity.json $ONOMY_HOME/contracts/eth-bridge/Gravity.json
