...
ETH_ORCHESTRATOR_VALIDATOR_PRIVATE_KEY=
while [[ $ETH_ORCHESTRATOR_VALIDATOR_PRIVATE_KEY = "" ]]; do
   read -r -p "Enter Ethereum private key for your orchestrator:" ETH_ORCHESTRATOR_VALIDATOR_PRIVATE_KEY
done
