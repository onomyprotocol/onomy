...
import (
	...
	onomyappparams "github.com/onomyprotocol/onomy-rebuild/app/params"
	"github.com/onomyprotocol/onomy-rebuild/x/globalfee"
	"github.com/onomyprotocol/onomy-rebuild/x/metaprotocols"
	metaprotocolstypes "github.com/onomyprotocol/onomy-rebuild/x/metaprotocols/types"
)
...
func appModules(
	app *OnomyApp,
	encodingConfig onomyappparams.EncodingConfig,
...
func orderInitBlockers() []string {
	return []string{
		...
		// For more details, please refer to the following link: https://github.com/onomyprotocol/onomy-rebuild/issues/2489
		globalfee.ModuleName,
		providertypes.ModuleName,
		consensusparamtypes.ModuleName,
		metaprotocolstypes.ModuleName,
