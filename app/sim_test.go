...
import (
	...
	"github.com/onomyprotocol/onomy-rebuild/ante"
	onomy "github.com/onomyprotocol/onomy-rebuild/app"

	// "github.com/onomyprotocol/onomy-rebuild/v11/app/helpers"
	// "github.com/onomyprotocol/onomy-rebuild/v11/app/params"
	"github.com/onomyprotocol/onomy-rebuild/app/sim"
)

// AppChainID hardcoded chainID for simulation
const AppChainID = "onomy-app"
...
func TestAppStateDeterminism(t *testing.T) {
	...
	appOptions[flags.FlagHome] = onomy.DefaultNodeHome
	...
	for i := 0; i < numSeeds; i++ {
		...
		for j := 0; j < numTimesToRunPerSeed; j++ {
			...
			_, _, err := simulation.SimulateFromSeed(
				...
				os.Stdout,
				app.BaseApp,
				simtestutil.AppStateFn(app.AppCodec(), app.SimulationManager(), onomy.NewDefaultGenesisState(encConfig)),
