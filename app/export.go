...
func (app *App) prepForZeroHeightGenesis(ctx sdk.Context, jailAllowedAddrs []string) { // nolint: gocognit,gocyclo,cyclop
	...
	err := iter.Close()
	if err != nil {
		log.Printf("error on KVStoreReversePrefixIterator close, %q", err)
	}
