...
onomyd genesis add-genesis-account $(onomyd keys show validator1 -a --keyring-backend=test --home=$HOME/.onomyd/validator1) 10000000000000000000000000000000stake,10000000000000000000000000000000anom,10000000000000000000000000000000nomUSD,10000000000000000000000000000000atom,10000000000000000000000000000000nomEUR,10000000000000000000000000000000nomJPY --home=$HOME/.onomyd/validator1 
onomyd genesis add-genesis-account $(onomyd keys show validator2 -a --keyring-backend=test --home=$HOME/.onomyd/validator2) 10000000000000000000000000000000stake,10000000000000000000000000000000anom,10000000000000000000000000000000nomUSD,10000000000000000000000000000000atom,10000000000000000000000000000000nomEUR,10000000000000000000000000000000nomJPY --home=$HOME/.onomyd/validator1 
onomyd genesis add-genesis-account $(onomyd keys show validator3 -a --keyring-backend=test --home=$HOME/.onomyd/validator3) 10000000000000000000000000000000stake,10000000000000000000000000000000anom,10000000000000000000000000000000nomUSD,10000000000000000000000000000000atom,10000000000000000000000000000000nomEUR,10000000000000000000000000000000nomJPY --home=$HOME/.onomyd/validator1 
