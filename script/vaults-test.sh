...
onomyd q bank balances $(onomyd keys show test2 -a --keyring-backend test --home /Users/donglieu/.onomyd/validator1)
...
onomyd tx auction bid 0 10000000nomUSD 2.2 --from test1 --home=$HOME/.onomyd/validator1 --keyring-backend test --fees 20stake --chain-id testing-1 -y

sleep 7

echo "I will buy all the remaining"
onomyd tx auction bid 0 20000000nomUSD 2 --from test3 --home=$HOME/.onomyd/validator1 --keyring-backend test --fees 20stake --chain-id testing-1 -y
