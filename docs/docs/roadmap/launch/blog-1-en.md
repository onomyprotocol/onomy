...
to delegate Atoms at launch. This is because the onomyd tool used in the guide
...
Right after Cosmos-SDK v0.31.0 is released, a Onomy testnet will be released in
...
- Download software directly from official sources, and make sure that you’re
  always using the latest, most secure version of onomyd when you’re doing
  anything that involves your 12 words. The latest versions of Tendermint, the
  Cosmos-SDK, and onomyd will always be available from our official GitHub
