...
:::tip
Txs where `extension_options` or `non_critical_extension_options` are populated with a type other than `/onomy.metaprotocols.ExtensionData` are considered invalid and will be rejected.
:::
