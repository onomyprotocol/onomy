...
If you want to open a PR on Onomy to update the documentation, please follow the guidelines in the [`CONTRIBUTING.md`](https://github.com/onomyprotocol/onomy-rebuild/tree/main/CONTRIBUTING.md)
...
The documentation for Onomy is hosted at:

- <https://hub.cosmos.network/>

built from the files in this (`/docs`) directory for [main](https://github.com/onomyprotocol/onomy-rebuild/tree/main/docs).

### How It Works

There is a [Github Action](https://github.com/onomyprotocol/onomy-rebuild/blob/main/.github/workflows/docs.yml)
...
[Makefile](https://github.com/onomyprotocol/onomy-rebuild/blob/main/Makefile) in this repo.
...
2. Edit API docs
   1. Directly Edit API docs manually: `cmd/onomyd/swagger-ui/swagger.yaml`.
   2. Edit API docs within the [Swagger Editor](https://editor.swagger.io/). Please refer to this [document](https://swagger.io/docs/specification/2-0/basic-structure/) for the correct structure in `.yaml`.
3. Download `swagger.yaml` and replace the old `swagger.yaml` under fold `cmd/onomyd/swagger-ui`.
4. Compile onomyd
